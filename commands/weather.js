...
exports.run = (bot, message, args, func) => {
        ...
        weather.find({search: args.join(" "), degreeType: "C"}, function(err, result) { // Make sure you got that args.join part
            ...
            const embed = new Discord.RichEmbed()
                ...
                .setColor(0xa07ae4) // This sets the color of the embed, you can chnage this to whatever you want, if you use a hex editor, make sure to put 0x in front of it.
